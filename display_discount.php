                    ...
                    <div class="card text-white bg-dark mb-3">
                        ...
                        <div class="card-body">
                            <ul class="row list-unstyled">
                                <li class="col-6 font-weight-bold">Description:</li>
                                <li class="col-6"><?= htmlspecialchars($product_description); ?></li>

                                <li class="col-6 font-weight-bold">List Price:</li>
                                <li class="col-6"><?= htmlspecialchars($list_price_f); ?></li>

                                <li class="col-6 font-weight-bold">Discount:</li>
                                <li class="col-6"><?= htmlspecialchars($discount_percent_f); ?></li>
